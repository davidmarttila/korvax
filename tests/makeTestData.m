...
function testLoad(output_path)
    ...
    wavfile         = sprintf('%s/test1_44100.wav', output_path)
    [y, sr]         = audioread(wavfile);
...
function testResample(output_path)
    ...
    wavfile         = sprintf('%s/test1_22050.wav', output_path);

    [y_in, sr_in]   = audioread(wavfile);
...
function testBeat(output_path)
    ...
    wavfile     = sprintf('%s/test2_8000.wav', output_path);
